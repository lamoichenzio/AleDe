...
const linkedin = ref("https://www.linkedin.com/in/alede/")
const instagram = ref("https://www.instagram.com/giasone.ale/")
const github = ref("https://github.com/lamoichenzio")
